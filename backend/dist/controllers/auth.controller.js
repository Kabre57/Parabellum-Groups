...
const authService = new auth_service_1.AuthService(utilisateurService); // Pass utilisateurService instance
class AuthController {
    register(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const registrationResult = yield authService.register({ nom, prenom, email, mot_de_passe, role_id });
                ...
                const utilisateurCree = yield utilisateurService.getById(registrationResult.utilisateur.userId);
                if (!utilisateurCree) {
    ...
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            // *** Log pour vérifier le corps de la requête reçu ***
            console.log("[AuthController] Received body in login:", req.body);
            try {
                ...
                const result = yield authService.login(email, mot_de_passe);
                if (result) {
    ...
    verifyAuth(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const utilisateur = yield utilisateurService.getById(decoded.userId);
                if (!utilisateur) {
